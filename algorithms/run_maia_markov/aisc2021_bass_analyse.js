...
// distribution for bassline representations for AI Song Contest 2021 project.
...
midiDirs.forEach(function(midiDir, jDir){
  ...
  files.forEach(function(file, iFile){
    ...
    try {
      ...
      let btracks = tx.find_bass_track(midi, false)
      console.log("btracks:", btracks)
      if (btracks !== undefined){
        btracks = btracks.map(function(d){ return d[0] })
