...
// Generating chord excerpts for AI Song Contest 2021 project.
...
const mainPaths = {
  "tom": {
    "stm": path.join(
      ...
      "2021", "io", "stm", "aisc2021_chords.js"
    ),
    "initial": path.join(
      "/Users", "tomthecollins", "Shizz", "York", "Projects", "AI\ Eurovision",
      "2021", "io", "stm", "aisc2021_chords_initial.js"
    ),
    "outputDir": path.join(
      "/Users", "tomthecollins", "Shizz", "York", "Projects", "AI\ Eurovision",
      "2021", "io", "out", "aisc2021_chords"
    )
  },
  "anotherUser": {
    "stm": "",
...
// Set up parameters.
let seeds = [
  "Lepaute", "Mitchel", "Lovelace", "Winlock", "Cannon",
  "Lee", "Cave-Browne-Cave", "Wilson", "Clem", "Froelich" ,
  "Clakre", "Paulson", "Aylard", "Rock", "Lever",
  "Briggs", "Howard", "Pearsall", "Lamarr", "Meltzer",
  "Holberton", "Antonelli", "Teitelbaum", "Bartik", "Spence",
  "Goldstine", "Wescoff", "Lichterman", "Worsely", "Hopper"
]
let param = {
...
seeds.map(function(seed){
  ...
  const me = new mm.MidiExport(
    gendOutput.points,
    path.join(pathsEtc["outputDir"], "chords_" + seed + ".mid"),
    0.5
  )
  fs.writeFileSync(
    path.join(path.join(pathsEtc["outputDir"], "chords_" + seed + ".txt")),
