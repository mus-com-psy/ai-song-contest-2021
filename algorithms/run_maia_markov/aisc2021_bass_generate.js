...
// Generating bassline excerpts for AI Song Contest 2021 project.
...
const mainPaths = {
  "tom": {
    "stm": path.join(
      ...
      "2021", "io", "stm", "aisc2021_bass.js"
    ),
    "initial": path.join(
      "/Users", "tomthecollins", "Shizz", "York", "Projects", "AI\ Eurovision",
      "2021", "io", "stm", "aisc2021_bass_initial.js"
    ),
    "outputDir": path.join(
      "/Users", "tomthecollins", "Shizz", "York", "Projects", "AI\ Eurovision",
      "2021", "io", "out", "aisc2021_bass"
    )
  },
  "anotherUser": {
    "stm": "",
...
// Set up parameters.
let seeds = [
  "Wicket", "Silly", "Slip", "Short", "Gully",
  "Mid-off", "Mid-on", "Mid-wicket", "Cover", "Short",
  "Fly", "Leg", "Deep", "Point", "Long",
  "Backward", "Fine", "Forward", "Wide", "Sweeper",
  "Straight", "Third", "Man", "Off", "On",
  "Bowler", "Batsman", "Umpire", "Tea", "Rain"
]
let param = {
...
seeds.map(function(seed){
  ...
  const me = new mm.MidiExport(
    gendOutput.points,
    path.join(pathsEtc["outputDir"], "bass_" + seed + ".mid"),
    0.5
  )
  fs.writeFileSync(
    path.join(path.join(pathsEtc["outputDir"], "bass_" + seed + ".txt")),
